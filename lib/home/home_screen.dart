        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: const [
                CategoryChip(label: 'BEEFSTEAK', emoji: '🥩', isSelected: true),
                CategoryChip(label: 'HOTDOG', emoji: '🌭'),
        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage('https://dynamic-media-cdn.tripadvisor.com/media/photo-o/28/71/47/c2/seafood-buffet-at-mezz.jpg?w=900&h=500&s=1'),
                fit: BoxFit.cover,
              ),
            ),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Burger - Chicken - Riche - Wing', style: TextStyle(color: Colors.grey)),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: const BoxDecoration(
                borderRadius: BorderRadius.vertical(top: Radius.circular(16)),
                image: DecorationImage(
                  image: NetworkImage('https://namviethathanh.com/wp-content/uploads/2019/05/7.C%C6%A1m-th%E1%BB%8Bt-kho-n%E1%BA%A5m-60k.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Com thit kho', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('30.000đ', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                    Container(
                      width: 30,
                      height: 30,
                      decoration: const BoxDecoration(
